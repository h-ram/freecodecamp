...
echo bon | script.sh
echo bon | ./script.sh
echo bon | ./script.sh 2> stderr.txt
echo bon | ./script.sh 2> stderr.txt > stdout.txt
...
grep --color meow kitty_ipsum_1.txt
grep --color meo kitty_ipsum_1.txt
grep --color -l meo kitty_ipsum_1.txt
grep --color -n meo kitty_ipsum_1.txt
man grep
grep -n meo kitty_ipsum_1.txt
grep -n meo kitty_ipsum_1.txt
...
grep --color --count meow[a-z]* kitty_ipsum_1.txt
man grep
grep --color --count meow[a-z]* kitty_ipsum_1.txt >> kitty_info.txt
grep --color -n --count meow[a-z]* kitty_ipsum_1.txt >> kitty_info.txt
grep --color  meow[a-z]* kitty_ipsum_1.txt >> kitty_info.txt
...
grep -oc  meow[a-z]* kitty_ipsum_1.txt 
...
echo -e "\nNumber of lines" >> kitty_infot.txt
echo -e "\nNumber of lines" >> kitty_info.txt
echo -e "\nNumber of lines:" >> kitty_info.txt
ls ..
ls ../..
...
echo -e "name.txtNumber of times cat, cats, or catnip appears:" >> kitty_info.txt
echo -e "\nNumber of times cat, cats, or catnip appears:" >> kitty_info.txt
...
./translate.sh < ./kitty_ipsum_1.txt
cat ./kitty_ipsum_1.txt | ./translate
cat ./kitty_ipsum_1.txt | ./translate.sh
./translate.sh ./kitty_ipsum_1.txt
./translate.sh ./kitty_ipsum_1.txt | grep dog
